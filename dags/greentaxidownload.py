...
# -------- Réglages ----------
BASE_FOLDER = "/opt/airflow/exports/staging"     
COLORS: Iterable[str] = ["green"]
YEAR_RANGE: Tuple[int, int] = (2009, 2025)    
...
@dag(
    dag_id="taxi_green_download_dag",
    start_date=datetime(2024, 1, 1),
    schedule= "@daily" ,           
    catchup=False,
    tags=["download", "parquet_green", "green_taxi"],
)
def taxi_green_download_dag():
